...
<link rel="stylesheet"
    href="${pageContext.request.contextPath}/assets/css/mediaelementplayer.css">
<link rel="stylesheet"
...
<link rel="stylesheet"
    href="${pageContext.request.contextPath}/assets/css/fl-bigmug-line.css">
<link rel="stylesheet"
                        ...
                        <div class="form-group text-center">
                            <div class="form-check">
                                <input type="checkbox" value="on" name="remember-me"
                                    id="remember-me" class="form-check-input"
