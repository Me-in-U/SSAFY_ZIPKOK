...
const properties = ref([
  {
    ...
    lat: 37.5,
    lng: 127.0,
    description: "강남 중심부에 위치한 프리미엄 아파트. 교통과 편의시설이 우수하며 투자 가치가 높습니다.",
  ...
  },
  {
    ...
    lat: 37.2,
    lng: 127.07,
    description: "동탄 신도시 핵심 입지에 위치한 아파트. 교육 환경이 우수하고 신도시 인프라가 잘 갖춰져 있습니다.",
...
function getAreaRange(areaOption) {
  switch (areaOption) {
    ...
    case 'large': return [30, 40];
    case 'xlarge': return [40, 100];
