<template>
    <div v-if="property"
        class="fixed top-0 left-0 h-full w-full md:w-1/3 lg:w-1/4 bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out overflow-hidden"
        :class="isOpen ? 'translate-x-0' : '-translate-x-full'"
        style="position: fixed; top: 0; left: 0; height: 100%; width: 100%; background-color: white; box-shadow: 0 10px 15px rgba(0, 0, 0, 0.1); z-index: 50; transform: translateX(0); transition: transform 0.3s ease-in-out; overflow: hidden;">
        <div class="h-full overflow-auto">
            ...
            <div class="p-4">
                ...
                <div class="flex items-center justify-between mb-4">
                    <span class="px-2 py-1 bg-emerald-100 text-emerald-800 text-sm rounded-md">{{ property.type
                    }}</span>
                ...
                <div class="border-b mb-4">
                    <div class="flex">
                        <button v-for="tab in tabs" :key="tab.id"
                            ...
                            :class="{ 'border-b-2 border-emerald-600 font-medium text-emerald-600': activeTab === tab.id, 'text-gray-500': activeTab !== tab.id }"
                ...
                <!-- 가격 이력 탭 -->
                <div v-if="activeTab === 'hireplace-with-user-password'" class="border rounded-md p-4">
                ...
                <div v-if="activeTab === 'analysis'" class="space-y-4">
                    ...
                    <div class="border rounded-md p-4">
                        ...
                        <p class="text-sm text-gray-700 mb-4">
                            이 매물은 {{ property.location }} 지역의 평균 대비 투자 가치가 높습니다.
                            최근 3년간 {{ property.priceChange }} 상승했으며, 향후 2년간 약 3~5%의 추가 상승이 예상됩니다.
...
const tabs = [
    ...
    { id: 'hireplace-with-user-password', name: '가격 이력', icon: CalendarIcon },
