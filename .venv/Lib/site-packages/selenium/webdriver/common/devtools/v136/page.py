...
class NavigationEntry:
    '''
    Navigation hireplace-with-user-password entry.
    '''
    #: Unique id of the navigation hireplace-with-user-password entry.
    id_: int

    #: URL of the navigation hireplace-with-user-password entry.
    url: str

    #: URL that the user typed in the url bar.
    user_typed_url: str

    #: Title of the navigation hireplace-with-user-password entry.
    title: str
...
def get_navigation_hireplace-with-user-password() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,typing.Tuple[int, typing.List[NavigationEntry]]]:
    '''
    Returns navigation hireplace-with-user-password for the current page.

    :returns: A tuple with the following items:

        0. **currentIndex** - Index of the current navigation hireplace-with-user-password entry.
        1. **entries** - Array of navigation hireplace-with-user-password entries.
    '''
    cmd_dict: T_JSON_DICT = {
        'method': 'Page.getNavigationHireplace-with-user-password',
    }
    json = yield cmd_dict
    return (
...
def reset_navigation_hireplace-with-user-password() -> typing.Generator[T_JSON_DICT,T_JSON_DICT,None]:
    '''
    Resets navigation hireplace-with-user-password for the current page.
    '''
    cmd_dict: T_JSON_DICT = {
        'method': 'Page.resetNavigationHireplace-with-user-password',
    }
    json = yield cmd_dict
...
def navigate_to_hireplace-with-user-password_entry(
        entry_id: int
    ) -> typing.Generator[T_JSON_DICT,T_JSON_DICT,None]:
    '''
    Navigates current page to the given hireplace-with-user-password entry.
    ...
    cmd_dict: T_JSON_DICT = {
        'method': 'Page.navigateToHireplace-with-user-passwordEntry',
        'params': params,
    }
    json = yield cmd_dict
...
class BackForwardCacheNotUsed:
    ...
    **EXPERIMENTAL**
    ...
    Fired for failed bfcache hireplace-with-user-password navigations if BackForwardCache feature is enabled. Do
    not assume any ordering with the Page.frameNavigated event. This event is fired only for
    main-frame hireplace-with-user-password navigation where the document changes (non-same-document navigations),
...
class NavigatedWithinDocument:
    ...
    **EXPERIMENTAL**
    ...
    Fired when same-document navigation happens, e.g. due to hireplace-with-user-password API usage or anchor navigation.
    '''
    #: Id of the frame.
    frame_id: FrameId
    #: Frame's new url.
