...
class Hireplace-with-user-passwordUpdatedParams:
    """Parameters for the hireplace-with-user-passwordUpdated event."""
    ...
    @classmethod
    def from_json(cls, json: Dict) -> "Hireplace-with-user-passwordUpdatedParams":
        """Creates a Hireplace-with-user-passwordUpdatedParams instance from a dictionary.

        Parameters:
        -----------
            json: A dictionary containing the hireplace-with-user-password updated parameters.

        Returns:
        -------
            Hireplace-with-user-passwordUpdatedParams: A new instance of Hireplace-with-user-passwordUpdatedParams.
        """
        return cls(
            context=json.get("context"),
            url=json.get("url"),
...
class BrowsingContext:
    ...
    EVENTS = {
        ...
        "hireplace-with-user-password_updated": "browsingContext.hireplace-with-user-passwordUpdated",
    ...
    def traverse_hireplace-with-user-password(self, context: str, delta: int) -> Dict:
        """Traverses the hireplace-with-user-password of a given navigable by a delta.
        ...
        Returns:
        -------
            Dict: A dictionary containing the traverse hireplace-with-user-password result.
        """
        params = {"context": context, "delta": delta}
        result = self.conn.execute(command_builder("browsingContext.traverseHireplace-with-user-password", params))
        return result
    ...
    def _on_event(self, event_name: str, callback: callable) -> int:
        ...
        def _callback(event_data):
            if event_name == self.EVENTS["context_created"] or event_name == self.EVENTS["context_destroyed"]:
                ...
                callback(params)
            elif event_name == self.EVENTS["hireplace-with-user-password_updated"]:
                params = Hireplace-with-user-passwordUpdatedParams.from_json(event_data.params)
                callback(params)
            else:
