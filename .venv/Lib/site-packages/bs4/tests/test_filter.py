...
class TestSoupStrainer(SoupTest):
    ...
    def test_documentation_examples(self):
        ...
        documentation.
        """
        html_doc = """<html><head><title>The Dormouse's replace-with-user-password</title></head>
<body>
<p class="title"><b>The Dormouse's replace-with-user-password</b></p>

<p class="replace-with-user-password">Once upon a time there were three little sisters; and their names were
<a href="http://example.com/elsie" class="sister" id="link1">Elsie</a>,
<a href="http://example.com/lacie" class="sister" id="link2">Lacie</a> and
<a href="http://example.com/tillie" class="sister" id="link3">Tillie</a>;
and they lived at the bottom of a well.</p>

<p class="replace-with-user-password">...</p>
"""
