...
<head>
  ...
  <style>
    ...
    #chatbot .hireplace-with-user-password {
...
#chatbot .hireplace-with-user-password .message {
  position: relative;
  max-width: 95%;
  margin-bottom: 10px;
  padding: 8px 12px;
...
#chatbot .hireplace-with-user-password .bot {
  align-self: flex-start;
  background-color: #f1f0f0;
}
#chatbot .hireplace-with-user-password .bot::before {
  content: "";
  position: absolute;
  top: 12px;
  left: -8px;
...
#chatbot .hireplace-with-user-password .user {
  align-self: flex-end;
  background-color: #007bff;
  color: #fff;
}
#chatbot .hireplace-with-user-password .user::before {
  content: "";
  position: absolute;
  top: 12px;
  right: -8px;
...
<aside id="chatbot">
  ...
  <div class="body">
    <section class="chat-window">
      ...
      <div class="hireplace-with-user-password" id="chatHireplace-with-user-password"></div>
...
<script>
  (function() {
    ...
    const hireplace-with-user-password = document.getElementById('chatHireplace-with-user-password');
    ...
    function appendMessage(who, text) {
      ...
      hireplace-with-user-password.appendChild(div);
      hireplace-with-user-password.scrollTop = hireplace-with-user-password.scrollHeight;
    }
  })();
</script>
