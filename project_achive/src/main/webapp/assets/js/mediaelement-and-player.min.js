												...
												function () {
													return 1 === (arguments.length <= 0 ? void 0 : arguments[0])
														? arguments.length <= 1
															...
															: arguments[1]
														: 0 === (arguments.length <= 0 ? void 0 : arguments[0]) ||
														  ((arguments.length <= 0 ? void 0 : arguments[0]) % 100 > 0 && (arguments.length <= 0 ? void 0 : arguments[0]) % 100 < 20)
														? arguments.length <= 2
															? void 0
															: arguments[2]
														: arguments.length <= 3
												...
												function () {
													return 1 === (arguments.length <= 0 ? void 0 : arguments[0])
														? arguments.length <= 1
															...
															: arguments[1]
														: 0 === (arguments.length <= 0 ? void 0 : arguments[0]) ||
														  ((arguments.length <= 0 ? void 0 : arguments[0]) % 100 > 1 && (arguments.length <= 0 ? void 0 : arguments[0]) % 100 < 11)
														? arguments.length <= 2
															? void 0
															: arguments[2]
														: (arguments.length <= 0 ? void 0 : arguments[0]) % 100 > 10 && (arguments.length <= 0 ? void 0 : arguments[0]) % 100 < 20
							...
							!(function (e) {
								if ("src" !== e) {
									var t = "" + e.substring(0, 1).toUpperCase() + e.substring(1),
										n = function () {
											return void 0 !== m.mediaElement.renderer && null !== m.mediaElement.renderer && "function" == typeof m.mediaElement.renderer["get" + t]
					...
					Object.assign(l.default.prototype, {
						...
						exitFullScreen: function () {
							...
							if (
								...
								if (((e.container.style.width = e.normalWidth + "px"), (e.container.style.height = e.normalHeight + "px"), t))
						...
						buildduration: function (e, t, n, o) {
							...
							if (t.lastChild.querySelector("." + r.options.classPrefix + "currenttime"))
								...
								t.querySelector("." + r.options.classPrefix + "currenttime") &&
									(0, l.addClass)(t.querySelector("." + r.options.classPrefix + "currenttime").parentNode, r.options.classPrefix + "currenttime-container");
						...
						buildtracks: function (e, t, n, o) {
							if ((this.findTracks(), e.tracks.length || (e.trackFiles && 0 !== !e.trackFiles.length))) {
								...
								if (r.options.toggleCaptionsButtonWhenOnlyOne && 1 === m)
									...
									for (
										var S = e.captionsButton.querySelectorAll("." + r.options.classPrefix + "captions-selector-label"), x = e.captionsButton.querySelectorAll("input[type=radio]"), w = 0, P = b.length;
										w < P;
										w++
									)
							...
							if (n) {
								...
								for (var o = 0; o < n; o++)
									t.chaptersButton.querySelector("ul").innerHTML +=
										...
										"</label></li>";
								for (
									var i = t.chaptersButton.querySelectorAll('input[type="radio"]'), r = t.chaptersButton.querySelectorAll("." + t.options.classPrefix + "chapters-selector-label"), a = 0, s = i.length;
									a < s;
									a++
								)
									(i[a].disabled = !1),
						...
						buildvolume: function (e, t, n, o) {
							if ((!l.IS_ANDROID && !l.IS_IOS) || !this.options.hideVolumeOnTouchDevices) {
								...
								var y = !1,
									...
									w =
										"vertical" === c ? a.container.querySelector("." + a.options.classPrefix + "volume-current") : a.container.querySelector("." + a.options.classPrefix + "horizontal-volume-current"),
								...
								o.addEventListener("rendererready", function () {
									...
									o.addEventListener("loadedmetadata", function () {
										setTimeout(function () {
											b || _ || ((0 === e.options.startVolume || o.originalNode.muted) && (o.setMuted(!0), (e.options.startVolume = 0)), o.setVolume(e.options.startVolume), a.setControlsSize()),
												(_ = !1);
										}, 250);
									}),
						...
						if (((o.node = o.media = r), o.node)) {
							...
							(o.options = Object.assign({}, g, n)),
								...
								o.options.timeFormat ||
									((o.options.timeFormat = "mm:ss"), o.options.alwaysShowHours && (o.options.timeFormat = "hh:mm:ss"), o.options.showTimecodeFrameCount && (o.options.timeFormat += ":ff")),
							...
							if (
								...
								if (
									...
									o.options.features.length ||
										...
										((o.container.style.background = "transparent"), (o.container.querySelector("." + o.options.classPrefix + "controls").style.display = "none")),
						...
						a(e, [
								...
								value: function (e, t) {
									...
									if (
										...
										n.container &&
											...
											(n.container.querySelector("." + n.options.classPrefix + "overlay-play").style.display = ""),
										!n.created)
									) {
										if (
											((n.created = !0),
							...
							},
							{
								...
								value: function (e) {
									...
									!o &&
										e &&
										(((o = l.default.createElement("img")).className = t.options.classPrefix + "poster-img"), (o.width = "100%"), (o.height = "100%"), (n.style.display = ""), n.appendChild(o)),
										e
													...
													switch (o.type) {
														case "mediaError":
															...
															if (!a || i - a > 3e3) (a = new Date().getTime()), p.recoverMediaError();
																...
																(s = new Date().getTime()), console.warn("Attempting to swap Audio Codec and recover from media error"), p.swapAudioCodec(), p.recoverMediaError();
															else {
					...
					u = {
						...
						canPlayType: function (e) {
							...
							return (d.IS_ANDROID && /\/mp(3|4)$/i.test(e)) ||
								(~["application/x-mpegurl", "vnd.apple.mpegurl", "audio/mpegurl", "audio/hls", "video/hls"].indexOf(e.toLowerCase()) && d.SUPPORTS_NATIVE_HLS)
								? "yes"
								: t.canPlayType
				...
				var i = o(e(3)),
					...
					c = {
						...
						getYouTubeId: function (e) {
							var t = "";
							return (
								e.indexOf("?") > 0 ? "" === (t = c.getYouTubeIdFromParam(e)) && (t = c.getYouTubeIdFromUrl(e)) : (t = c.getYouTubeIdFromUrl(e)), (t = t.substring(t.lastIndexOf("/") + 1).split("?"))[0]
							);
						},
