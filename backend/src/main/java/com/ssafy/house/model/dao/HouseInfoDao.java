...
public interface HouseInfoDao {
    ...
    // apt_seq 리스트 조회
    List<HouseInfo> selectBySeqList(List<String> aptSeqList) throws Exception;
    ...
    // HouseFullInfo 전체 조회
    HouseFullInfo selectHouseFullInfo(@Param("aptSeq") String aptSeq) throws Exception;
    //  주변 학교 조회
    List<SchoolInfo> selectSchoolsByAptSeq(@Param("aptSeq") String aptSeq) throws Exception;
}
