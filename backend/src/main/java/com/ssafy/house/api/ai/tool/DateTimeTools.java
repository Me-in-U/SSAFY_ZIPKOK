...
/**
 * AI 도구 호출에서 사용하는 날짜 및 시간 기능을 제공한다.
 */
@Component
...
public class DateTimeTools {
    ...
    private void setAlarm(LocalDateTime alarmTime, String osName) throws IOException, InterruptedException {
        ...
        if (osName.contains("mac")) {
            ...
            log.debug("윈도우 알람 예약 스크립트 실행: {}", Arrays.toString(windowScript));
        ...
        log.info("알람 예약 완료: {}",
                alarmTime.format(DateTimeFormatter.ofPattern("yyyy년 MM월 dd일 HH시 mm분 ss초")));
    }
